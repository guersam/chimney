...
private[dsl] trait TransformerFDefinitionVersionSpecific[F[+_], From, To, C <: TransformerCfg, Flags <: TransformerFlags] {
  this: TransformerFDefinition[F, From, To, C, Flags] =>
