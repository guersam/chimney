...
private[dsl] trait ScalaVersionSpecificTransformerDefinition[From, To, C <: TransformerCfg, Flags <: TransformerFlags] {
  ...
  /** Use `value` provided here for field picked using `selector`.
    ...
    */
  def withFieldConst[T, U](selector: To => T, value: U): TransformerDefinition[From, To, _, Flags] =
  ...
  def withFieldComputed[T, U](
      selector: To => T,
      map: From => U
  ): TransformerDefinition[From, To, _, Flags] =
  ...
  /** Use `f` to calculate the (missing) coproduct instance when mapping one coproduct into another.
    ...
    *   [[io.scalaland.chimney.dsl.TransformerDefinition]]
    */
  def withCoproductInstance[Inst](f: Inst => To): TransformerDefinition[From, To, _, Flags] =
