...
private[dsl] trait ScalaVersionSpecificTransformerFInto[F[+_], From, To, C <: TransformerCfg, Flags <: TransformerFlags] {
  ...
  /** Use `value` provided here for field picked using `selector`.
    ...
    */
  def withFieldConst[T, U](selector: To => T, value: U): TransformerFInto[F, From, To, _, Flags] =
  ...
  /** Use wrapped `value` provided here for field picked using `selector`.
    ...
    *   [[io.scalaland.chimney.dsl.TransformerFInto]]
    */
  def withFieldConstF[T, U](selector: To => T, value: F[U]): TransformerFInto[F, From, To, _, Flags] =
  ...
  /** Use `f` to calculate the (missing) coproduct instance when mapping one coproduct into another.
    ...
    *   [[io.scalaland.chimney.dsl.TransformerFInto]]
    */
  def withCoproductInstance[Inst](f: Inst => To): TransformerFInto[F, From, To, _, Flags] =
  ...
  /** Use `f` to calculate the (missing) wrapped coproduct instance when mapping one coproduct into another
    ...
    *   [[io.scalaland.chimney.dsl.TransformerFInto]]
    */
  def withCoproductInstanceF[Inst](f: Inst => F[To]): TransformerFInto[F, From, To, _, Flags] =
    ??? // macro TransformerFIntoWhiteboxMacros.withCoproductInstanceFImpl

  /** Apply configured wrapped transformation in-place.
    *
    * It runs ??? // macro that tries to derive instance of `TransformerF[F, From, To]` and immediately apply it to captured
    * `source` value.
    *
    * It requires [[io.scalaland.chimney.TransformerFSupport]] instance for `F` to be available in implicit scope of
